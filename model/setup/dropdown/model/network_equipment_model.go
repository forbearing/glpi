...
func init() {
	pkgmodel.Register[*NetworkEquipmentModel]()
}

// NetworkEquipmentModel 网络设备型号
type NetworkEquipmentModel struct {
	pkgmodel.Base
...
func (*NetworkEquipmentModel) GetTableName() string {
	return fmt.Sprintf("%s_%s", model.PREFIX_DROPDOWN, pkgmodel.GetTableName[*NetworkEquipmentModel]())
}
