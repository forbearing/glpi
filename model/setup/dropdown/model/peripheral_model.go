...
func init() {
	pkgmodel.Register[*PeripheralModel]()
}

// PeripheralModel 外设型号
type PeripheralModel struct {
	pkgmodel.Base
...
func (*PeripheralModel) GetTableName() string {
	return fmt.Sprintf("%s_%s", model.PREFIX_DROPDOWN, pkgmodel.GetTableName[*PeripheralModel]())
}
